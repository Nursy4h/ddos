...
mengetik('')
mengetik('DEDOS DDOS DD')
mengetik('Team : IMPERIOR T24M')                                                         
mengetik('ANGGOTA : REMESTER/THIO/ZENTHER/HAREFA')
mengetik('')
mengetik('')
...
os.system('xdg-open https://api.whatsapp.com/send?phone=628137644text=hallo%20admin%20naz%20semoga%20harimu.menyenangkan:) ')
